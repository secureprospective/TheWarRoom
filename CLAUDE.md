...
| B2b-Fetch-Offense — CFBD API key | **OPEN (Christopher)** — mint at collegefootballdata.com/key; endpoint 401s without it; then confirm CFBD exposes targets (likely NOT → receiver share = reception/yardage share) |
