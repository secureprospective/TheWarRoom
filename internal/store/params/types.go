...
// SEPARATE record (the default stays immutable), so re-seeding never clobbers it and
// an override could be cleared back to the default later. Admin-only write path
// (AD-05) — never routed through B7.
